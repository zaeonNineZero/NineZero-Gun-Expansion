 ...
 */
public class BallisticScopeModel implements IOverrideModel
{
    private static final ResourceLocation RETICLE = new ResourceLocation(nzgExpansion.MOD_ID, "textures/effect/ballistic_scope_reticle.png");
    ...
    public void render(float partialTicks, ItemCameraTransforms.TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int light, int overlay)
    {
        ...
        if(this.isFirstPerson(transformType) && entity.equals(Minecraft.getInstance().player))
        {
            ...
            matrixStack.pushPose();
            {
                ...
                matrixStack.translate(-size / 2, 0.85 * 0.0625, 3.75 * 0.0625);
