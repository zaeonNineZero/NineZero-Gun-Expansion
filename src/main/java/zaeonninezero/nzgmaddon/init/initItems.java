...
public class initItems {
    ...
    public static final RegistryObject<GunItem> HEAVY_PISTOL = ITEMS.register("heavy_pistol", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<GunItem> HEAVY_REVOLVER = ITEMS.register("heavy_revolver", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
	...
	public static final RegistryObject<GunItem> COMPACT_SMG = ITEMS.register("compact_smg", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    ...
    public static final RegistryObject<GunItem> BULLPUP_RIFLE = ITEMS.register("bullpup_rifle", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    ...
    public static final RegistryObject<Item> IMPROVED_SILENCER = ITEMS.register("improved_silencer", () -> new BarrelItem(Barrel.create(12.2F, GunModifiers.SILENCED, ExtraGunModifiers.MUFFLED_IMPROVED), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> PERFORMANCE_SILENCER = ITEMS.register("performance_silencer", () -> new BarrelItem(Barrel.create(12.2F, GunModifiers.SILENCED, ExtraGunModifiers.MUFFLED_PERFORMANCE), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
