...
public class initItems {
	...
	//Guns
    public static final RegistryObject<GunItem> REVOLVER = ITEMS.register("revolver", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> HEAVY_PISTOL = ITEMS.register("heavy_pistol", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> HEAVY_REVOLVER = ITEMS.register("heavy_revolver", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> UZI = ITEMS.register("uzi", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> SUBMACHINE_GUN = ITEMS.register("submachine_gun", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
	public static final RegistryObject<GunItem> COMPACT_SMG = ITEMS.register("compact_smg", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> RAPID_SMG = ITEMS.register("rapid_smg", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> PUMP_SHOTGUN = ITEMS.register("pump_shotgun", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> HUNTING_SHOTGUN = ITEMS.register("hunting_shotgun", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> DOUBLE_BARRELED_SHOTGUN = ITEMS.register("double_barreled_shotgun", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
	public static final RegistryObject<GunItem> AUTOMATIC_SHOTGUN = ITEMS.register("automatic_shotgun", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> HEAVY_ASSAULT_RIFLE = ITEMS.register("heavy_assault_rifle", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    ...
    public static final RegistryObject<GunItem> BOLT_ACTION_RIFLE = ITEMS.register("bolt_action_rifle", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
    public static final RegistryObject<GunItem> SNIPER_RIFLE = ITEMS.register("sniper_rifle", () -> new GunItem(new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
	
	//Ammo
	public static final RegistryObject<Item> MEDIUM_BULLET = ITEMS.register("medium_bullet", () -> new AmmoItem(new Item.Properties().tab(nzgmAddon.GROUP)));
	
	//Scopes / Sights
	public static final RegistryObject<Item> DOT_SIGHT = ITEMS.register("dot_sight", () -> new ScopeItem(Scopes.DOT_SIGHT, new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
	public static final RegistryObject<Item> CHEVRON_SCOPE = ITEMS.register("chevron_scope", () -> new ScopeItem(Scopes.CHEVRON_SCOPE, new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
	public static final RegistryObject<Item> BALLISTIC_SCOPE = ITEMS.register("ballistic_scope", () -> new ScopeItem(Scopes.BALLISTIC_SCOPE, new Item.Properties().stacksTo(1).tab(nzgmAddon.GROUP)));
