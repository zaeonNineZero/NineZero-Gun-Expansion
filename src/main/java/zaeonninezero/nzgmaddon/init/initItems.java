...
public class initItems {
	...
	public static final RegistryObject<GunItem> AUTOMATIC_MARKSMAN_RIFLE = ITEMS.register("automatic_marksman_rifle", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
